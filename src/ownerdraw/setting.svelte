...
import {palitrans,tosim,fontsize} from '../ts/store.ts';
...
<StateBtn states={{0:"原樣",1:"简體",2:"简体"}} storeid={tosim}/>
{#if hasLang('pp')}
{_("Pali:")}
    <StateBtn states={{'':_("儉約 Provident"),'iast':_("羅馬 Roman"),
    'my':_("緬 ဗမာစာ"),'th':_("泰 ไทย"),'lo':_("寮 ລາວ"),'km':_("柬 ភាសាខ្មែរ"),
    'hi':_("天城 हिन्दी"),'si':_("僧伽羅 සිංහල"),'tb':"藏 བོད་སྐད།"}} storeid={palitrans}/>
{/if}
<div><VersionInfo/></div>
<div class="logo">Accelon2023.5.19</div>
<hr/>
<style>
